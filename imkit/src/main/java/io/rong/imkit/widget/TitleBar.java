...
public class TitleBar extends Toolbar {
    ...
    public void setOnRightMoreClickListener(OnRightIconClickListener l) {
        this.mOnRightIconClickListener = l;
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        getMiddleView().setOnClickListener(new OnClickListener() {
            @Override
    ...
    public ImageView getMoreView() {
        if (mMore == null) {
            mMore = findViewById(R.id.im_more_click);
        }
        return mMore;
    }
    ...
    public void setMoreViewVisibility(boolean visibility) {
        getMoreView().setVisibility(visibility ? View.VISIBLE : View.GONE);
    }
