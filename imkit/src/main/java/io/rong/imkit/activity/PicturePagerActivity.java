...
public class PicturePagerActivity extends RongBaseNoActionbarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        overridePendingTransition(R.anim.rc_picture_anim_fade_in, R.anim.rc_picture_anim_fade_in);
        ...
        Animation animation  = AnimationUtils.loadAnimation(this, R.anim.rc_picture_anim_enter); //加载动画资源文件
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Animation animation  = AnimationUtils.loadAnimation(PicturePagerActivity.this, R.anim.rc_picture_anim_exit); //加载动画资源文件
        mViewPager.setAnimation(animation);
                            ...
                            new CustomTarget<Bitmap>() {
                                ...
                                public void onResourceReady(
                                    ...
                                    if (resource != null
                                        ...
                                        try {
                                            desBitmap = resource.copy(Bitmap.Config.ARGB_8888, true);
