...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    protected void init() {
        View inflate = View.inflate(getContext(), R.layout.ps_title_bar, this);

        setClickable(true);
        setFocusable(true);
        config = SelectorProviders.getInstance().getSelectorConfig();
        viewTopStatusBar = inflate.findViewById(R.id.top_status_bar);
        titleBarLayout =  inflate.findViewById(R.id.rl_title_bar);
        ivLeftBack =  inflate.findViewById(R.id.ps_iv_left_back);
        rlAlbumBg =  inflate.findViewById(R.id.ps_rl_album_bg);
        ivDelete =  inflate.findViewById(R.id.ps_iv_delete);
        viewAlbumClickArea =  inflate.findViewById(R.id.ps_rl_album_click);
        tvTitle =  inflate.findViewById(R.id.ps_tv_title);
        ivArrow =  inflate.findViewById(R.id.ps_iv_arrow);
        tvCancel =  inflate.findViewById(R.id.ps_tv_cancel);
        titleBarLine =  inflate.findViewById(R.id.title_bar_line);
