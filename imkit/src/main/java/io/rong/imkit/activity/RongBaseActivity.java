...
import io.rong.imkit.widget.NewTitleBar;
...
public class RongBaseActivity extends AppCompatActivity {
    ...
    protected NewTitleBar newTitleBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newTitleBar = findViewById(R.id.view_new_title_bar);
        ...
        ImmersionBar.with(this)
                ...
                .init();
        mTitleBar.setVisibility(isShowNewTitleBar()?View.GONE:View.VISIBLE);
        newTitleBar.setVisibility(isShowNewTitleBar()?View.VISIBLE:View.GONE);
        SDActivityManager.Companion.getInstance().onCreate(this);
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        SDActivityManager.Companion.getInstance().onDestroy(this);
