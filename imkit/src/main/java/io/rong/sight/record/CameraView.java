...
public class CameraView extends RelativeLayout
    ...
    private void initRetryView() {
        ...
        LayoutParams imageViewRetryParam =
                new LayoutParams(controlIconWidth, controlIconWidth);
    ...
    private void initSubmitView() {
        ...
        LayoutParams imageViewSubmitParam =
                new LayoutParams(controlIconWidth, controlIconWidth);
    ...
    private void initPlayControlView() {
        ...
        LayoutParams imageViewPlayControlParam =
                new LayoutParams(controlIconWidth, controlIconWidth);
