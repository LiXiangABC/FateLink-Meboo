...
public class DelayClickEditText extends BaseEditText {

  public DelayClickEditText(Context context) {
    super(context);
  }

  public DelayClickEditText(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public DelayClickEditText(Context context, AttributeSet attrs, int defStyleAttr) {
