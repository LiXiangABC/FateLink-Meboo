...
public class DelayClickButton extends BaseButton {
  public DelayClickButton(Context context) {
    super(context);
  }

  public DelayClickButton(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public DelayClickButton(Context context, AttributeSet attrs, int defStyleAttr) {
