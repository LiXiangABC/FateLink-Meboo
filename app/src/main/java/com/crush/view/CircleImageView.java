...
public class CircleImageView extends BaseImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_yt_civ_border_width, 0);
        this.mBorderColor = a.getColor(R.styleable.CircleImageView_yt_civ_border_color, -16777216);
        this.mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_yt_civ_border_overlay, false);
        this.mFillColor = a.getColor(R.styleable.CircleImageView_yt_civ_fill_color, 0);
        a.recycle();
        this.init();
    }
