...
import io.rong.imkit.conversation.messgelist.provider.TipsMessageItemProvider;
...
public class ConversationConfig {
    ...
    public int rc_message_reading_burn_interval = 3600000;//毫秒
    ...
    private CopyOnWriteArrayList<IConversationSummaryProvider> mConversationSummaryProviders = new CopyOnWriteArrayList<>();
    ...
    private void initMessageProvider() {
        ...
        addMessageProvider(new TipsMessageItemProvider());
    ...
    public Spannable getMessageSummary(Context context, Conversation conversation) {
        ...
        ListIterator<IConversationSummaryProvider> listIterator = mConversationSummaryProviders.listIterator();
        // 遍历集合并输出元素
        while (listIterator.hasNext()) {
            IConversationSummaryProvider item = listIterator.next();
