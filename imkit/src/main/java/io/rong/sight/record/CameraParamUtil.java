...
public class CameraParamUtil {
    ...
    public Size getPreviewSize(List<Size> list, int th, float rate, Size preferSize) {
        if (list == null) return null;
        Size prefer = getPreferSize(list, preferSize);
    ...
    public Size getVideoSize(List<Size> list, int th, float rate, Size preferSize) {
        if (list == null) return null;
        Size prefer = getPreferSize(list, preferSize);
        if (prefer != null) return prefer;
    ...
    public Size getPreferSize(List<Size> list, Size preferSize) {
        for (Size size : list) {
