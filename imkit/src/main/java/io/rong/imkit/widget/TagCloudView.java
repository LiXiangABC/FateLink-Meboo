...
public class TagCloudView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.shape_tag_bg;
...
//                tagView.setBackgroundResource(R.drawable.shape_tag_bg);
    ...
    public void getTags(int position, int colorId, int resId) {
        TextView tagView = (TextView) getChildAt(position);
        tagView.setTextColor(colorId);
