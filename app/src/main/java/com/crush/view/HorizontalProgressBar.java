...
public class HorizontalProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mMax = a.getInteger(R.styleable.HorizontalProgressBar_zpb_max, 100);
        mProgress = a.getInteger(R.styleable.HorizontalProgressBar_zpb_progress, 0);
        mBgColor = a.getColor(R.styleable.HorizontalProgressBar_zpb_bg_color, 0xff3F51B5);
        mProgressColor = a.getColor(R.styleable.HorizontalProgressBar_zpb_pb_color, 0xffFF4081);
        mSecondProgressColor = a.getColor(R.styleable.HorizontalProgressBar_zpb_second_pb_color, 0xffFF4081);
        mPadding = a.getDimensionPixelSize(R.styleable.HorizontalProgressBar_zpb_padding, 0);
        mShowZeroPoint = a.getBoolean(R.styleable.HorizontalProgressBar_zpb_show_zero_point, false);
        mShowSecondProgress = a.getBoolean(R.styleable.HorizontalProgressBar_zpb_show_second_progress, false);
        mSecondProgress = a.getInteger(R.styleable.HorizontalProgressBar_zpb_second_progress, 0);
        mSecondProgressShape = a.getInteger(R.styleable.HorizontalProgressBar_zpb_show_second_point_shape, SHAPE_POINT);
        mOpenGradient = a.getBoolean(R.styleable.HorizontalProgressBar_zpb_open_gradient, false);
        mGradientFrom = a.getColor(R.styleable.HorizontalProgressBar_zpb_gradient_from, 0xffFF4081);
        mGradientTo = a.getColor(R.styleable.HorizontalProgressBar_zpb_gradient_to, 0xffFF4081);
        mOpenSecondGradient = a.getBoolean(R.styleable.HorizontalProgressBar_zpb_open_second_gradient, false);
        mShowMode = a.getInt(R.styleable.HorizontalProgressBar_zpb_show_mode, SHOW_MODE_ROUND);
        mSecondGradientFrom = a.getColor(R.styleable.HorizontalProgressBar_zpb_second_gradient_from, 0xffFF4081);
        mSecondGradientTo = a.getColor(R.styleable.HorizontalProgressBar_zpb_second_gradient_to, 0xffFF4081);
        mRadius = a.getDimensionPixelSize(R.styleable.HorizontalProgressBar_zpb_round_rect_radius, 20);
        mDrawBorder = a.getBoolean(R.styleable.HorizontalProgressBar_zpb_draw_border, false);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.HorizontalProgressBar_zpb_border_width, 1);
        mBorderColor = a.getColor(R.styleable.HorizontalProgressBar_zpb_border_color, 0xffff001f);
        a.recycle();
    }
