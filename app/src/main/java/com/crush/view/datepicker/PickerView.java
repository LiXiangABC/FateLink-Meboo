package com.crush.view.datepicker;
...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.color_FF465D);
        mDarkColor = ContextCompat.getColor(mContext, R.color.color_202323);
    }
