...
public class SnapUpCountDownTimerView extends LinearLayout {
    ...
    private ImageView time_separation_hour;
    private ImageView time_separation_min;
    ...
    public SnapUpCountDownTimerView(Context context, AttributeSet attrs) {
        ...
        View view = inflater.inflate(R.layout.layout_index_no_more_match, this);
        ...
        time_separation_hour = (ImageView) view.findViewById(R.id.time_separation_hour);
        time_separation_min = (ImageView) view.findViewById(R.id.time_separation_min);
    ...
    public void setSeparation(int resId){
        time_separation_hour.setImageResource(resId);
        time_separation_min.setImageResource(resId);
    }
