...
public final class PictureConfig {
    ...
    public static final String PRIVATE_PHOTO_PREVIEW = "private_photo_preview";
    public static final String PRIVATE_PHOTO_PREVIEW_TRANSFORM = "private_photo_preview_transform";
