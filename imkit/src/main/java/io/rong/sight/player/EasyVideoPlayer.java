...
//        initSightListView();
    ...
    private void initPlayView() {
        ...
        LayoutParams imageViewPlayParam =
                new LayoutParams(
    ...
    private void initCloseView() {
        ...
        LayoutParams imageViewCloseParam =
                new LayoutParams(
                        ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void initSightListView() {
        ...
        LayoutParams imageViewSightListParam =
                new LayoutParams(
                        ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void setFitToFillAspectRatio(MediaPlayer mp, int videoWidth, int videoHeight) {
        if (mp != null && mTextureView != null) {
            ...
            ViewGroup.LayoutParams videoParams = mTextureView.getLayoutParams();
