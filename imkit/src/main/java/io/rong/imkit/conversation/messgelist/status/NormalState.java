...
//                        viewModel.executePageEvent(new Event.RefreshEvent(RefreshState.LoadFinish));
                        if (weakVM.get() != null) {
                            ...
                            weakVM.get().executePageEvent(new Event.RefreshEvent(RefreshState.LoadFinish));
                        }
...
//                            viewModel.executePageEvent(new Event.RefreshEvent(RefreshState.RefreshFinish));
                            ...
                            if (weakVM.get() != null) {
                                weakVM.get().onGetHistoryMessage(list);
                                weakVM.get().executePageEvent(new Event.RefreshEvent(RefreshState.RefreshFinish));
                            }
