package com.crush.view.codeview;
...
public class VerificationCodeView extends RelativeLayout {
    ...
    private void initTextViews(Context context, int etNumber, int etWidth, Drawable etDividerDrawable, float etTextSize, int etTextColor) {
        ...
        for (int i = 0; i < mPwdTextViews.length; i++) {
            ...
            Typeface typeface = TypefaceCompat.createFromResourcesFontFile(context, context.getResources(), R.font.interbold, "", 0,0);
    ...
    public void setText(String inputContent) {
        ...
        for (int i = 0; i < mPwdTextViews.length; i++) {
            ...
            if (tv.getText().toString().trim().equals("")) {
                ...
                tv.setBackgroundDrawable(tv.getText().toString().trim().equals("")?mEtBackgroundDrawableNormal:mEtBackgroundDrawableFocus);
                if (i < mEtNumber - 1) {
