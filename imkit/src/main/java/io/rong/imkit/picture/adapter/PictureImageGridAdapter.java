...

                                {
                                    ...
                                    if (PictureMimeType.eqVideo(mimeType)) {
                                        ...
                                        if ((Integer.parseInt(videoTime[0]) * 60
                                            ...
                                            String time;
                                            if (maxDuration >= 60) {
                                                time = context.getResources().getString(R.string.rc_picsel_selected_max_time_span_with_param, maxDuration / 60.0);
                                            } else {
                                                time = context.getResources().getString(R.string.rc_picsel_selected_max_second_span_with_param, maxDuration);
                                            }
