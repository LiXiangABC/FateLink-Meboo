    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("isFull",false)){
            ...
            if (params instanceof ViewGroup.MarginLayoutParams) {
                ...
                int currentHeight = params.height; // 假设Toolbar的高度之前已经设置
                params.height= currentHeight + StatusBarUtil.getStatusBarHeight(this);
                mTitleBar.setLayoutParams(params);
                mTitleBar.getParent().requestLayout();
                mTitleBar.setBackgroundResource(R.drawable.icon_web_title_bar);
            }
        }else {
