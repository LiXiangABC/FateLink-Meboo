...
class FirstClickPrivateDialog(var ctx: Context, var type:Int,var listener: FirstClickPrivateListener) :  BasePopupWindow(ctx) {
    init {
        setContentView(R.layout.dialog_first_click_private)
        initView()
    }
