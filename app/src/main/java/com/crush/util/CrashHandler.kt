...
//            SDActivityManager.instance.finishAllActivity()
            // 退出程序
...
//            SpName.error,
//            Gson().toJson(ErrorInfoEntity(
//            SystemUtil.systemVersion,
//            BaseConfig.getInstance.getString(io.rong.imkit.SpName.appId,""),
//            "",
//            sb.toString(),
//            SystemUtil.deviceBrand,
//            UserUtil.getPhone(),
//            SystemUtil.systemModel,
//            SDViewUtil.screenHeight.toString(),
//            SDViewUtil.screenWidth.toString(),
//            "",
//            UserUtil.getUniqueId(),
//            BaseConfig.getInstance.getString(io.rong.imkit.SpName.uuid,""),
//            SDPackageUtil.versionName
//        )))
        try {
            ...
            if (Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED) {
                val dir = File(mContext!!.externalCacheDir!!.path + fileName)
                if (!dir.exists()) {
                    dir.createNewFile()
                }
                val fos = FileOutputStream(dir, true)
